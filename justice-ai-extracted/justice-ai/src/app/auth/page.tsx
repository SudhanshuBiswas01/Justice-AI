    ...
    <div className="relative grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative flex items-center justify-center p-6">
        ...
        >
          ...
          {/* Google */}
          <button className="group flex w-full items-center justify-center gap-3 rounded-xl border border-white/15 bg-white/[0.03] py-3 text-sm font-medium transition-all duration-300 hover:border-white/30 hover:bg-white/[0.06]">
            <GoogleIcon />
