        ...
        <header className="glass z-10 flex items-center justify-between gap-4 border-b border-white/10 px-5 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="group relative grid size-10 place-items-center rounded-xl bg-brand-gradient text-sm font-semibold text-white shadow-glow"
            >
              {initials}
              <span className="absolute -bottom-8 right-0 hidden rounded-lg border border-white/10 bg-card px-2 py-1 text-[10px] text-muted-foreground group-hover:flex items-center gap-1 whitespace-nowrap z-50">
